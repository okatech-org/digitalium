...
const translations = {
  fr: {
    ...
    "services.cta": "Découvrir tous nos services",
    ...
    "features.demo.request": "Prépare un dossier pour ma demande de visa France",
    "features.demo.response": "J'ai trouvé 5 documents dans vos archives. Je crée le dossier 'Visa France 2024' avec : passeport, relevés bancaires (3 derniers mois), attestation employeur...",
    
    // Contact
    "contact.title1": "Parlons de Votre",
    "contact.title2": "Projet",
    "contact.description": "Notre équipe est disponible pour répondre à toutes vos questions et vous accompagner dans votre transformation digitale.",
    ...
    "contact.form.error.description": "Une erreur est survenue. Veuillez réessayer.",
    "contact.map": "Carte",
    ...
    "faq.a1": "DIGITALIUM est la première plateforme d'archivage intelligent multi-échelle qui combine IA générative et rigueur institutionnelle. Notre assistant archiviste analyse automatiquement vos documents, les classe, extrait les métadonnées et vous aide à les retrouver instantanément grâce à une recherche sémantique avancée.",
    "faq.q2": "Mes documents sont-ils sécurisés sur DIGITALIUM ?",
    "faq.a2": "Absolument. Nous utilisons un chiffrement AES-256 pour les données au repos et TLS 1.3 pour les données en transit. Pour les institutions, nous proposons une option de chiffrement de bout en bout avec hébergement souverain au Gabon. Toutes les actions sont tracées dans un journal d'audit immutable.",
    "faq.q3": "Quels types de documents puis-je scanner et archiver ?",
    "faq.a3": "DIGITALIUM accepte tous types de documents : CNI, passeports, diplômes, factures, contrats, actes notariés, relevés bancaires, certificats médicaux, et bien plus. Notre IA détecte automatiquement le type de document et l'organise dans la bonne catégorie.",
    "faq.q4": "Puis-je utiliser DIGITALIUM hors ligne ?",
    "faq.a4": "Oui ! DIGITALIUM fonctionne en mode offline-first. Vous pouvez scanner, organiser et consulter vos documents même sans connexion internet. Tout se synchronise automatiquement dès que vous retrouvez une connexion.",
    "faq.q5": "Comment fonctionne la tarification ?",
    "faq.a5": "Nous proposons une offre gratuite avec 1 Go de stockage et 100 documents. L'offre Personal à 2 000 XAF/mois inclut 10 Go et documents illimités. L'offre Family à 5 000 XAF/mois permet jusqu'à 5 utilisateurs. Pour les entreprises et institutions, contactez-nous pour un devis personnalisé.",
    "faq.q6": "L'IA peut-elle vraiment comprendre mes documents ?",
    "faq.a6": "Oui, notre IA utilise des modèles de dernière génération pour analyser visuellement et textuellement vos documents. Elle peut extraire des données structurées (dates, montants, noms), détecter les documents expirés, et même vous suggérer des actions comme la création de dossiers thématiques.",
    "faq.q7": "Comment DIGITALIUM aide les entreprises ?",
    "faq.a7": "Pour les entreprises, DIGITALIUM offre des workflows automatisés (validation de factures, onboarding employés), la gestion multi-utilisateurs avec RBAC, des tableaux de bord analytiques, l'intégration API, et des rapports de conformité. Le ROI moyen constaté est de 253% avec un temps de retour sur investissement de 15 jours.",
    "faq.q8": "DIGITALIUM est-il disponible pour les administrations publiques ?",
    "faq.a8": "Oui, nous proposons une offre Institutional spécialement conçue pour les mairies, ministères et administrations. Elle inclut le déploiement on-premise, l'hébergement souverain au Gabon, la conformité RGPD et loi gabonaise, ainsi qu'un support dédié 24/7.",
    
    // Footer
    "footer.description": "L'archiviste intelligent qui transforme votre gestion documentaire. Made in Gabon 🇬🇦",
    ...
    "auth.subtitle": "Accédez à votre espace personnel",
    ...
    "auth.accountExistsMsg": "Un compte existe déjà avec cet email. Connectez-vous plutôt.",
  ...
  en: {
    ...
    // Footer
    "footer.description": "The intelligent archivist that transforms your document management. Made in Gabon 🇬🇦",
